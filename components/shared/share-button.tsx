            ...
            <div className="flex flex-col">
              {shareTargets(url, title).map((target) => (
                <a
                  ...
                  className="flex min-h-11 items-center gap-2.5 rounded-md px-2.5 text-text-primary transition-colors hover:bg-surface-alt"
                >
              ...
              <button
                type="button"
                onClick={copyLink}
                className="flex min-h-11 w-full items-center gap-2.5 rounded-md px-2.5 text-left text-text-primary transition-colors hover:bg-surface-alt"
              >
                {copied ? (
